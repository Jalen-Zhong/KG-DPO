...
export DATASET="./data/train/sft_chatml.jsonl"
export SPLIT_DATASET_RATIO=0
export SWANLAB_EXP_NAME="hotpot-graphgen-sft-qwen2.5-1.5b-base"
...
# 执行通用训练脚本
bash ./train/swift-sft-generic.sh